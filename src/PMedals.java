...
public class PMedals {

	public static void main(String[] args) throws IOException {
		String[] lines = new String(Files.readAllBytes(Paths.get("output/pscores.tsv"))).trim().split("\n");
		...
		Files.write(Paths.get("output/pmedals.json"), json.toString().getBytes());
	}
